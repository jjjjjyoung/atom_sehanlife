...
<article id="bo_v" class="<?php echo $cancel_class ?> <?php echo $final_class ?>" style="width:<?php echo $width; ?>">
	<?php if($cancel_class == 'cancel_class') { ?>
		<span class="cancel_class_btn">폐강</span>
	<?php } ?>

	<?php if($final_class == 'final_class') { ?>
		...
		<div class="board_box">
			<div class="box_inner">
				<div class="title_info">
					...
					<div class="course_sub_name">
						<span><?php echo $view['wr_1'] ?></span>
					</div>
					<div class="course_wrap_price">
						<span><?php echo $view['wr_7'] ?></span>원
					</div>
				</div>
				<div class="class_info">
					<ul>
						...
						<li class="li_full">
							<dl>
								<dt>접수기간</dt>
								<dd><?php echo str_replace('||', ' ~ ', $view['wr_4']) ?></dd>
							</dl>
						</li>
						<li class="li_full">
							<dl>
								<dt>교육시간</dt>
								<dd><?php echo $view['wr_5'] ?></dd>
							</dl>
						</li>
						<li class="li_half">
							<dl>
    ...
    <section id="bo_v_atc">
		...
		<div class="class_intro">
			<h3 class="intro_tit">교육소개</h3>
			<div class="intro_info"><?php echo nl2br($view['wr_8']);?></div>
		</div>

		<div class="class_intro">
			<h3 class="intro_tit">교수소개</h3>
			<div class="intro_info"><?php echo nl2br($view['wr_9']);?></div>
		</div>
		<div class="class_intro">
			<h3 class="intro_tit">커리큘럼</h3>
